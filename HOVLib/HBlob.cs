...
namespace HOVLib
{
    public class HBlob
    {
        ...
        {
            blobTool.Label(hMat.Mat.ToIplImage());
        ...
        {
            Point[][] contours;
            OpenCvSharp.CPlusPlus.HierarchyIndex[] hierarchies;
            Cv2.FindContours(hMat.Mat, out contours, out hierarchies, ContourRetrieval.CComp, ContourChain.ApproxNone);
